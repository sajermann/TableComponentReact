...
describe("pages/TableMega/TableMegaLoadingPage/Sort/components/Manual", () => {
  it("renders form containing TableMega structure", () => {
    const screen = render(<Manual columns={[]} data={[]} />);
    expect(screen.getByTestId("section-title").textContent).toBe("MANUAL_SORT");
